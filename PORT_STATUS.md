...
| RBatis 扩展族 | 进行中 | cache-core、caffeine、redis、memcached、r2dbc、typehandlers-jsr310、rbatis-plus 已独立建仓并固定 revision；rbatis-plus 五 crate alpha 纵切与 `ddd4r-data-rbatisplus` 共享 SQLite/Outbox 契约通过；高级增强及 Redis Cluster/Sentinel 拓扑仍未完成 |
