...
| [`rbatis-plus`](https://github.com/rbatis-plus/rbatis-plus) | `8e32bb9c1e55a6419147fb89659066748540f1c1` | 原生 Mapper CRUD/批量/分页、Wrapper、乐观锁、逻辑删除；AES-256-GCM、blind index、行签名、轮换、部分行策略、审计填充与固定六阶段链 | SQLite 与安全契约已通过；SM4/SM3 provider、Mapper 自动装配和四数据库矩阵待补 |
