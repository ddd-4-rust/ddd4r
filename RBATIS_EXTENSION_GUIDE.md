...
| [`rbatis-plus`](https://github.com/rbatis-plus/rbatis-plus) | `72cc23e07c4fe3676bcd2a88520093652092758a` | 原生 Mapper CRUD/批量/分页、Wrapper、乐观锁、逻辑删除；Mapper 执行前后拦截器接线；AES-256-GCM、blind index、行签名、轮换、部分行策略、审计填充 | 真实 SQLite 端到端管线通过；SM4/SM3、默认安全装配和四数据库矩阵待补 |
